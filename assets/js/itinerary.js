...
const TRIP = {
  ...
  checklist: [
    ...
    { t: "換匯", d: "帶<b>台幣現金</b>到當地換最划算，免特地換美金；台灣端頂多線上結匯換 1–2 千壓身。到素萬那普出關後<b>下到 B 樓（Airport Rail Link 層）</b>找 SuperRich（橘）／Happy Rich 換，匯率幾乎等同市區——別在入境層 2F 的 K Bank 櫃檯換（差很多）。<br>換匯帶護照；ATM 每筆手續費 250 THB、只應急，跳出 DCC 選泰銖計價。大鈔匯率較好，記得拆小鈔給計程車／街邊。" },
